...
struct InstructionInfo {
  InstructionInfo(std::string mnemonic, uint8_t length, uint8_t cycles) noexcept
      : mnemonic(std::move(mnemonic)), length(length), cycles(cycles), longCycles(0) { }

  InstructionInfo(std::string mnemonic, uint8_t length, uint8_t cycles, uint8_t longCycles) noexcept
      : mnemonic(std::move(mnemonic)), length(length), cycles(cycles), longCycles(longCycles) { }
   ...
   *
   * If this instruction is a conditional instruction this is the \e longer instruction duration in
   * cycles.
   *
